...
function setupDB() {
	var dbFile = air.File.applicationStorageDirectory.resolvePath("voucherentry_live.db");
...
function exportHtmlFile() {
	...
	var contents = '<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">' + "\n" 
      ...
      + '<meta http-equiv="Content-Type" content="text/html; charset=utf-8">' + "\n"
		...
		+ "   td, th { text-align: left; padding: 3px; margin: 2px; text-transform: uppercase; }\n"
		+ "</style>\n"
...
function bindButtons() {
	$('.nav #home_voucher_entry').bind("click mouseup", function() { 
		hideAllBut("entry"); 
		if ( getNumVouchersets() == 1 && $('#amount_1').val().length < 2 ) {
			$('#voucherset_1').remove();
		}
	...
	$('.nav #home_edit_defaults').bind("click mouseup", function() { setupDefaults(); });
	$('.nav #home_about').bind("click mouseup", function() { hideAllBut("about"); });
	$('.nav #home_exit').bind("click mouseup", function() { applicationExit(); });
	$('.nav #setup_close').bind("click mouseup", function() { saveDefaults(); hideAllBut("home"); });
	$('.nav #entry_close').bind("click mouseup", function() { hideAllBut("home"); });
	$('.nav #about_close').bind("click mouseup", function() { hideAllBut("home"); });
	$('.nav #entry_export').bind("click mouseup", function() { exportTextFile(); });
	$('.nav #entry_print').bind("click mouseup", function() { 
